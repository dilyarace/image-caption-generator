...
# https://colab.research.google.com/drive/1aR8h4QGRpYI4OliN8HjX3DR3wkqhrYfH?usp=sharing
...
BASE_DIR = adityajn105_flickr8k_path
WORKING_DIR = '/content'
...
model.fit(generator, steps_per_epoch=steps, epochs=epochs, verbose=1)
